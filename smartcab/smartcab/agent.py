...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = (waypoint, tuple(inputs), deadline)
        #state=None
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, epsilon=0.5, alpha=0.01)
    ...
    sim.run(n_test=1000, tolerance=0.5)
